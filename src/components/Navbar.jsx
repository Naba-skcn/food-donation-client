    ...
    return (
        <div className="navbar bg-base-100">
            <div className="navbar-start">
                ...
                <div className="btn btn-ghost text-1xl lg:text-2xl font-bold"><img className='w-[70px] h-[55px]' src="https://media.istockphoto.com/id/1038356020/vector/restaurant-icon.jpg?s=612x612&w=0&k=20&c=Tk_v3JuJA4lz_8ZRJi78xS4p75Idqt97uEtYJciVtFI=" alt="" />Delish<span className='text-[#66A000]'>Domain</span></div>
            </div>
