            ...
            <div className='font-semibold' style={{ backgroundImage: "url('https://media.istockphoto.com/id/1466389057/photo/abstract-soft-background.jpg?s=612x612&w=0&k=20&c=yEuwKt6tC4RBz25UH4RhH4VkgP6WVH-IZ3M4Qzk2vB4=')", backgroundSize: 'cover', backgroundPosition: 'center', padding: '40px', borderRadius: '8px', boxShadow: '0px 0px 20px rgba(0, 0, 0, 0.1)' }}>
                <article className="max-w-2xl px-6 py-24 mx-auto space-y-12 dark:bg-gray-100 dark:text-gray-900">
                    <div className="w-full mx-auto space-y-4 text-center">
                        <p className="text-xs font-semibold tracking-wider mt-[-80px] uppercase">#NutriHarvest</p>
                        <h1 className="text-4xl font-bold leading-tight md:text-5xl">
                            <Typewriter
                                words={['Join Us in Nourishing Communities with NutriHarvest']}
                                loop={5}
                                cursor
                                cursorStyle='_'
                                typeSpeed={70}
                        ...
                        <p className="text-sm dark:text-gray-600">by
                            <span className="font-semibold"> The NutriHarvest Team</span>
                            on
                            <time dateTime="2024-05-12"> May 12th, 2024</time>
                        </p>
                    </div>
                    <div className="dark:text-gray-800">
                        <p>Welcome to NutriHarvest, where we are dedicated to fighting hunger and nourishing communities in need. Our mission is to collect surplus food and redistribute it to those facing food insecurity, ensuring that no one goes hungry.</p>
                        <p>Through the generosity of donors and volunteers, we strive to make a meaningful impact by providing nutritious meals to individuals and families who are struggling to put food on the table. Join us in our efforts to create a world where everyone has access to healthy and sustainable food sources.</p>
                    </div>
                    <div className="pt-12 border-t dark:border-gray-300">
                        <div className="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
                            ...
                            <div className="flex flex-col">
                                ...
                                <p className="dark:text-gray-600">Our team at NutriHarvest is committed to making a difference in the fight against hunger. With compassion and dedication, we work tirelessly to ensure that no one in our community goes hungry.</p>
                            </div>
                        </div>
